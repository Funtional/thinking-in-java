...
/*
 * 练习38：
 *  (3)使用<code>CarBuilder</code>中的方式，对本章中给出的房屋构建过程建模。
 */
...
class FootingsDigger implements Runnable {
    ...
    public FootingsDigger(HouseQueue hq) {
        houseQueue = hq;
    }
...
class Reporter2 implements Runnable {
    ...
    public Reporter2(HouseQueue houseQueue) {
